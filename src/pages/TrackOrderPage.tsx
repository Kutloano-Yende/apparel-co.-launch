...
import { Package, Search, CheckCircle2, Truck, Clock, XCircle, ArrowRight } from "lucide-react";
      ...
      <div className="container-brand max-w-3xl mx-auto">
        <FadeInView>
          ...
          <p className="text-muted-foreground mb-10">
            Enter your order ID to see the latest status and shipment details.
          </p>
        </FadeInView>
        ...
        <FadeInView delay={0.1}>
          <form onSubmit={handleSearch} className="flex gap-3 mb-12">
            ...
            <button type="submit" disabled={isLoading || !orderId.trim()} className="btn-primary px-8 disabled:opacity-50">
          ...
          <FadeInView>
            <div className="text-center py-16 border border-border">
              ...
              <p className="text-sm text-muted-foreground max-w-md mx-auto">
                We couldn't find an order with that ID. Double-check and try again, or check your confirmation email for the correct order ID.
              </p>
            </div>
          </FadeInView>
        )}
